...
pluralCaseList.push( {plural: "pointerservices/pointers", pascal: "PointerservicePointer"} )

pluralCaseList.push( {plural: "paymentservices/payments", pascal: "PaymentservicePayment"} )

pluralCaseList.push( {plural: "historyservices/histories", pascal: "HistoryserviceHistory"} )

pluralCaseList.push( {plural: "webtoonmanagementservices/webtoons", pascal: "WebtoonmanagementserviceWebtoon"} )

pluralCaseList.push( {plural: "purchaseservices/purchases", pascal: "PurchaseservicePurchase"} )
