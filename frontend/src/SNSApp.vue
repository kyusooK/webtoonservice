            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="webtoons"
                        to="/webtoonmanagementservices/webtoons"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                ...
                description: '', 
                key: 'pointers', 
                route: '/pointerservices/pointers',
                ImageUrl: '',
            },
            { 
                title: 'Payment', 
                description: '', 
                key: 'payments', 
                route: '/paymentservices/payments',
                ImageUrl: '',
            },
            { 
                title: 'History', 
                description: '', 
                key: 'histories', 
                route: '/historyservices/histories',
                ImageUrl: '',
            },
            { 
                title: 'Webtoon', 
                description: '', 
                key: 'webtoons', 
                route: '/webtoonmanagementservices/webtoons',
                ImageUrl: '',
            },
            { 
                title: 'Purchase', 
                description: '', 
                key: 'purchases', 
                route: '/purchaseservices/purchases',
                ImageUrl: '',
            },
